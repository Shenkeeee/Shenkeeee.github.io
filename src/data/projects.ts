...
export const hobbyWeb = [
  {
    title: "Fish Anomaly Detector",
    subtitle: "Research Support Tool",
    tech: "React + FastAPI + AI + Railway",
    desc: "Website that uses AI models on the backend to flag physical and health abnormalities in fish for a scientific research project. Has a fully editable result onto a canvas on the frontend with clipboard usage.",
    img: "./assets/fishSegmenter.webp",
    alt: "Fish analyzer interface",
    projectUrl: "https://halak-web-support-production.up.railway.app/",
  },
  {
    title: "Wedding Site",
